            ...
            <div className="mx-auto max-w-7xl px-4">
                <div className="header">
                    ...
                    <div className="md:flex-1 md:flex md:items-center md:justify-end">
                            <div className="flex items-center md:ml-12 gap-2">
                                <nav className="flex space-x-10"><a className="btn-gallery-icon" href="#"><img src="../img/icon-other.png" /></a></nav>
                                <nav className="flex space-x-10"><a className="btn-gallery-icon" href="#" onClick={manageSetting}><img src="../img/icon-setting.png" /></a></nav>
                                <nav className="flex space-x-10"><a className="de-menu-profile close" href="#" onClick={manageUser}><img src={user.profilePhotoeUrl?user.profilePhotoeUrl:'../img/author_thumbnail.jpg'} /></a></nav>
                                <div id="setting" className="de-submenu" style={{ display: showSetting ? "block" : "none" }}>
                                    <div className="heading">Setting</div>

                                    <form onSubmit={handleSubmit(onSubmit)}>
                                        <div className="form-group">
                                            <label>Graphics Quality :</label>
                                            <select {...register("graphics")} className="form-control">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <select {...register("render")} className="form-control">
                                                <option value="low">low  </option>
                                                <option value="medium">medium</option>
                                                <option value="high">high</option>
                                            </select>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div className="switch-with-title">
                                                <div className="de-switch">
                                                    <input {...register("checkbox")} type="checkbox" id="switch-unlock" className="checkbox"/>
                                ...
                                <div id="user" className="de-submenu" style={{ display: show ? "block" : "none" }}>
