        ...
        <div className="flex-shrink-0">
          <div className="relative">
            <img
              ...
              src={
                profile.profilePhotoeUrl
                  ? profile.profilePhotoeUrl
                  : "/metaframe/img/house.jpg"
              }
              alt=""
            />
            <span
            ...
            <div className="mt-8 grid grid-cols-4 gap-4">
              {spaces.map((space) => (
                <div
                  ...
                  key={space.id}
                  onClick={() =>
                    navigate("/create-unity-gallery", { state: space.id })
                  }
                >
                  <div className="flex flex-col items-center justify-center h-60 w-40  relative">
                    <div
                      ...
                      style={{
                        ...
                        boxShadow:
                          "inset 0 2px 3px rgba(255,255,255,0.3), inset 0 -2px 3px rgba(0,0,0,0.3), 0 1px 1px rgba(0,0,0,0.9)",
                      }}
                    ></div>
